**DO NOT USE ON LIVE SITE. Use on development site with most recent trunk version of BuddyPress 1.6.**
...
--- Changelog ---
1.6 Minor bug fixes and update template files to match BuddyPress 1.6. 
