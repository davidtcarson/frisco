...
Go to "Appearance > Theme Options" to configure basic color and font options. Create a custom.css file in the root directory of the theme and enable the custom stylesheet in Thme Options to override default styles.  
