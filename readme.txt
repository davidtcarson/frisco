--- Frisco ---
A clean and simple child theme for BuddyPress 1.3+. Frisco uses the BuddyPress default theme as its parent theme. BuddyPress must be active for Frisco to function. Frisco is currently being developed and should be added to the WordPress themes repository shortly after BuddyPress 1.3 is released. 
...
There's a new admin bar coming to BuddyPress 1.3. To use that new admin bar on your development site, add the following line to your wp-config.php file in your root directory: 
